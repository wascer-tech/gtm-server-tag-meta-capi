...
function writeEnhancementCookie(userData) {
  ...
  // noEncode = true guarda o base64 cru. O template oficial da Meta le esse
  // cookie com getCookieValues('_gtmeec', true), ou seja sem decodificar, e so
  // enxerga o valor se ele estiver cru. Na leitura a gente decodifica, que e
  // no-op em base64 e recupera o cookie que a tag deles gravou codificado.
